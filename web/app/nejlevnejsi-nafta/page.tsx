...
export const metadata: Metadata = {
  title: `Nejlevnější nafta v ČR dnes – aktuální ceny`,
  description: 'Kde je dnes nejlevnější nafta v České republice? Kompletní přehled cen nafty na čerpacích stanicích. Aktualizováno každých 6 hodin.',
  alternates: { canonical: 'https://benzinmapa.cz/nejlevnejsi-nafta' },
  keywords: ['nejlevnější nafta', 'nafta cena dnes', 'levná nafta', 'nafta ČR', 'ceny nafty čerpací stanice'],
};

const FAQS = [
  { q: 'Kde je dnes nejlevnější nafta v ČR?', a: 'Přehled nejlevnějších čerpacích stanic s naftou je aktualizován každých 6 hodin. Viz tabulka níže.' },
  { q: 'Kolik stojí litr nafty v ČR?', a: 'Průměrná cena nafty v ČR se mění každý týden. Aktuální průměr najdete v přehledu na naší stránce.' },
  { q: 'Jak ušetřit za naftu?', a: 'Tankujte v supermarketových čerpacích stanicích nebo nezávislých provozovatelích, kteří mívají ceny pod průměrem sítí.' },
];

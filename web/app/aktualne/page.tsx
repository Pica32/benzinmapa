...
const POSTS = [
  ...
  {
    slug: 'proc-je-nafta-drazsi-nez-benzin-2026',
    title: 'Proč je nafta dražší než benzín? Odpověď pro rok 2026',
    excerpt: 'Ještě před pár lety byla nafta vždy levnější. Dnes to neplatí. Vysvětlujeme, proč se poměr obrátil a co to znamená pro majitele dieselových aut.',
    date: '2026-04-23',
    readTime: '5 min',
    tag: 'Vysvětlení',
  },
  {
    slug: 'vernostni-karty-cerpackich-stanic-srovnani',
    title: 'Věrnostní karty čerpacích stanic: Benzina, MOL, Shell — která se skutečně vyplatí?',
    excerpt: 'Testujeme bonusové programy tří největších sítí. Kolik musíte natankovat, abyste se dostali k reálné slevě? Výsledky jsou překvapivé.',
    date: '2026-04-21',
    readTime: '7 min',
    tag: 'Test',
  },
...
const TAG_COLORS: Record<string, string> = {
  ...
  'Průvodce': 'bg-teal-100 text-teal-700',
  'Vysvětlení': 'bg-yellow-100 text-yellow-700',
  'Test': 'bg-pink-100 text-pink-700',
};

export default function AktualniPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <nav className="text-sm text-gray-500 mb-6 flex gap-2">
        <Link href="/" className="hover:text-green-600">Domů</Link>
        <span>›</span>
        <span className="text-gray-900 dark:text-white">Aktuálně</span>
      </nav>

      <div className="flex items-center gap-3 mb-8">
        <Newspaper className="text-green-600" size={28} />
        <div>
          <h1 className="text-3xl font-black text-gray-900 dark:text-white">Aktuálně</h1>
